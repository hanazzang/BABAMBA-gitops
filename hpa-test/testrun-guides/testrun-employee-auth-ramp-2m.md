...
./hpa-test/run-k6-testrun.sh platform/k6-hpa-test/testrun-templates/employee-auth-ramp-2m.yaml
```
...
kubectl -n k6 logs -f -l k6_cr=employee-auth-ramp-2m --max-log-requests=20 --tail=50
