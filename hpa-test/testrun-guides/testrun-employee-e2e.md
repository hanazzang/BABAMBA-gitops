...
./hpa-test/run-k6-testrun.sh platform/k6-hpa-test/testrun-templates/employee-e2e.yaml
```
...
kubectl -n k6 logs -f -l k6_cr=employee-e2e --max-log-requests=20 --tail=50
